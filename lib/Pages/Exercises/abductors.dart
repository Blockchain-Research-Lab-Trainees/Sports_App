...
class Abductors extends StatefulWidget {
  const Abductors({Key? key}) : super(key: key);

  @override
  _AbductorsState createState() => _AbductorsState();
}

class _AbductorsState extends State<Abductors> {
  List<dynamic> names = [];
  ...
  Future<void> fetchCal() async {
    ...
    const url =
        "https://exercises-by-api-ninjas.p.rapidapi.com/v1/exercises?muscle=abductors";
