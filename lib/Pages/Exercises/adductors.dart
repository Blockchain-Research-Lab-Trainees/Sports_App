...
class Adductors extends StatefulWidget {
  const Adductors({Key? key}) : super(key: key);

  @override
  _AdductorsState createState() => _AdductorsState();
}

class _AdductorsState extends State<Adductors> {
  List<dynamic> names = [];
  ...
  Future<void> fetchCal() async {
    ...
    const url =
        "https://exercises-by-api-ninjas.p.rapidapi.com/v1/exercises?muscle=adductors";
