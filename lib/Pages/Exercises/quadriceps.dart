...
class Quadriceps extends StatefulWidget {
  const Quadriceps({Key? key}) : super(key: key);

  @override
  _QuadricepsState createState() => _QuadricepsState();
}

class _QuadricepsState extends State<Quadriceps> {
  List<dynamic> names = [];
  ...
  Future<void> fetchCal() async {
    ...
    const url =
        "https://exercises-by-api-ninjas.p.rapidapi.com/v1/exercises?muscle=quadriceps";
