...
class Fore extends StatefulWidget {
  const Fore({Key? key}) : super(key: key);

  @override
  _ForeState createState() => _ForeState();
}

class _ForeState extends State<Fore> {
  List<dynamic> names = [];
  ...
  Future<void> fetchCal() async {
    ...
    const url =
        "https://exercises-by-api-ninjas.p.rapidapi.com/v1/exercises?muscle=forearms";
